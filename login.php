    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form >
                ...
                <input type="password" name="password" placeholder="Enter Password Here" class="input-field" required>
        ...
        <div class="form-container sign-in">
            <form>
                ...
                <input type="phone" name="phone-number" placeholder="Phone Number" class="input-field" required>
